    ...
    with st.spinner("Searching live web..."):
        try:
            ...
            prompt = f"""
                ...
                - For Value Score Rationale: Use chain of thought logic to justify the Value Score. Use exactly 2-3 short bullets in an HTML <ul><li>...</li></ul>. Utilize Reddit and Google Maps reviews for insight if available.
